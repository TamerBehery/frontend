          ...
          <table className="w-full min-w-[1024px]">
            <thead>
              <tr className="border-t-2 border-b-2">
                ...
                <th className="min-w-6 max-w-6 font-serif font-semibold text-right py-1 px-3">
                  سنة التجديد
                </th>
                <th className="min-w-8 max-w-8 font-serif font-semibold text-right py-1 px-3">
                  حالة الطلب
              ...
              {requests?.map((request) => {
                return (
                  <tr key={request.Request_ID} className="border-b-[1px]">
                    ...
                    <td className="min-w-6 max-w-6 font-sans font-normal text-right py-1 px-3">
                      {request.Year}
